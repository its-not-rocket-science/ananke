...
import { SCALE, clampQ, q, qMul, mulDiv } from "./units";
...
export function generateIndividual(seedU32, arch) {
    ...
    const actuatorScale = clampQ(qMul(actuatorScaleBase, (SCALE.Q + ((sizeComposite - SCALE.Q) >>> 2))), q(0.6), q(1.8));
